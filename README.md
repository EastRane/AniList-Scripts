...
### AniList WallHaven Exporter

Allows to export anime names as a list of WallHaven sets for John's Background Switcher.

## TMDB

### TMDB Review Bridge

Adds several small utility buttons for Obsidian/Quartz page write process.
